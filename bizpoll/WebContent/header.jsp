...
<div id="wrap">
	<header>
		<div id="logo">
			<a href="index.bizpoll"><img alt="" src="images/product_img/w2.jpg" border="1" style="border-color: black" width="180" height="100"></a>
		</div>
			...
			<ul>
				<c:choose>
					...
					<c:otherwise>
						...
						<li>|</li>
						<li><a href="mypages.bizpoll">MY PAGE</a></li>
					</c:otherwise>
				</c:choose>
				<li>|</li>
				<li><a>CART</a></li>
